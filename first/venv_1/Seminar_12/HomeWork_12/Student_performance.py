...
if __name__ == '__main__':
    student_1 = Student("Михайл", "Викторович", "Федосин", Path('lessons.csv'))
    student_1("русский язык", 3)
    student_1("русский язык", 5)
    student_1("физика", 4)
    student_1("математика", 4)
    student_1("информатика", 31, "test")
    student_1("математика", 98, "test")
    ...
    student_2 = Student("Сергей", "Матвеевич", "Сузиков", Path('lessons.csv'))
    student_2("русский язык", 5)
    student_2("история", 5)
    student_2("физика", 3)
    student_2("математика", 5)
    student_2("история", 45, "test")
    student_2("история", 98, "test")
    student_2("химия", 4)
    student_2("информатика", 5)
    student_2("информатика", 51, "test")
