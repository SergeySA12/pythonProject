...
from first.venv_1.Seminar_14.Semin13_Task5 import UserWorkshop, User
from first.venv_1.Seminar_14.Exceptions import AccesErorr, LevelError
from first.venv_1.Seminar_14.Semin13_User import User
@pytest.fixture()
def set_up():
