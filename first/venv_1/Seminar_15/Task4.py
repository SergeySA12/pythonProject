...
if __name__ == '__main__':
    print('3-й вторник мая:', text_to_date('1-й понедельник май'))
    print('5-й четверг ноября:', text_to_date('2-й вторник ноября'))
    print('4-я среда мая:', text_to_date('3-я среда май'))